...
import {ArticleForm} from "../warehouse/all-items/ArticleForm";
...
class ArticleMain extends Component {
    ...
    render() {
        ...
        const steps = [
            {
                ...
                content: <ArticleForm method={method} item={item}
                                      next={(item) => this.setItem(item)}/>,
            },
            {
                title: t('stock_info'),
                content: <StockInformation method={method}
                                           item={item}
            ...
            },
            {
                ...
                content:
                    <RelatedImages method={method} item={item}
                                   prev={() => this.prev()}
        ...
        if (method === methods.edit && loading) {
            ...
            return (
                <Drawer
                    title={method === methods.edit ? t('update_item_new') : t('create_article')}
                    placement="right"
                    closable={false}
                    maskClosable={false}
...
export default (withTranslation('common')(ArticleMain));
