...
import GroupProfileView from "./EntityProfileView";
import GroupProfileCreate from "./EntityProfileCreate";

class EntityProfileMethod extends Component {
    ...
    setComponent() {
        ...
        if (match.params.method === methods.create || (match.params.method === methods.edit && match.params.id))
            ...
            history.push(routes.dashboard.profiles.entity.self);
    }
...
export default EntityProfileMethod;
