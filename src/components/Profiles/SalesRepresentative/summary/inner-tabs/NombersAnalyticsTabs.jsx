...
import {InvoiceCountAnalyticsGet,} from "../../../../../controller/API/salesOperationAPI";
...
class NombersAnalyticsTabs extends Component {
    state = {
        loading: false,
        data: {},
        tableData: "",
    ...
    handleFilterForm = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                InvoiceCountAnalyticsGet(values).then((res) => {
...
export default withTranslation("common")(
    Form.create({name: "revenueAnalytics"})(NombersAnalyticsTabs)
);
