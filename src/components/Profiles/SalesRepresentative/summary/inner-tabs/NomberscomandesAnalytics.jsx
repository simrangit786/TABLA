...
import {WorkorderCountAnalyticsGet,} from "../../../../../controller/API/salesOperationAPI";
...
class NomberscomandesAnalytics extends Component {
    state = {
        loading: false,
        data: {},
        tableData: "",
    ...
    handleFilterForm = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                WorkorderCountAnalyticsGet(values).then((res) => {
                    ...
                    >
                        ...
                        >
                            {this.state.tableData ? (
                                <BarChartTableData data={this.state.tableData}/>
                            ) : (
                                " "
                            )}
                        </TabPane>
...
export default withTranslation("common")(
    Form.create({name: "revenueAnalytics"})(NomberscomandesAnalytics)
);
