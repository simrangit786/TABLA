...
import {salesAnalytics, salesRepresentativeGetOneByUser} from "../../../controller/API/profileApi";
...
class AnalytiqueRepresentative extends Component {
    ...
    componentDidMount() {
        ...
        if (id) {
            this.setState({loading: true});
            salesAnalytics(id).then(
                resp => {
                    this.setState({results: resp});
                    this.setAnalyticsData(resp);
                    this.setTotalValues(resp);
...
export default withTranslation('common')(AnalytiqueRepresentative);
