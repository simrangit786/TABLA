...
import {salesProfileOrderGet} from "../../../controller/API/profileApi";
import {showErrors} from "../../../controller/utils";

const {TabPane} = Tabs;


class NumberOrdersRepresentative extends Component {
    state = {
        data: null,
        year1: 2020,
        year2: 2021,
    ...
    componentDidMount() {
        this.fetchSalesProfileOrderData({year1: this.state.year1, year2: this.state.year2})
    }
    ...
    updateYears = (year1, year2) => {
        ...
        this.fetchSalesProfileOrderData({year1, year2})
    }
...
export default NumberOrdersRepresentative;